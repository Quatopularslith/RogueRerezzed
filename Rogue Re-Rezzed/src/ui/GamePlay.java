    ...
    public void paint(Graphics g) {
        ...
        for (int xx = 0; xx < l.board.length; xx++) {
            for (int yy = 0; yy < l.board[xx].length; yy++) {
                if (l.board[xx][yy] && !(xx * 64 + offx <= -64 || xx * 64 + offx >= getWidth() || yy * 64 + offy <= -64 || yy >= getHeight())) {
                    g2.drawImage(fsp.i, xx * 64 + offx, yy * 64 + offy, this);
                }
            }
        }
        ...
        for (int i = 0; i < current.size(); i++) {
            if (current.get(i) != null) {
                ...
                if (current.get(i).x * 64 + offx <= -64 || current.get(i).x * 64 + offx >= getWidth() || current.get(i).y * 64 + offy <= -64 || current.get(i).y >= getHeight()) {
                    continue;
                }
        ...
        for (int xx = 0; xx < l.board.length; xx++) {
            for (int yy = 0; yy < l.board[xx].length; yy++) {
                if (!(xx * 8 + moffx > getWidth() - (getWidth() / 4) - 8 && xx * 8 + moffx < getWidth() - 18)) {
                    continue;
                }
                if (!(yy * 8 + moffy > 10 && yy * 8 + moffy < 10 + (getHeight() * 0.3515625 - 10))) {
                    continue;
                }
                if (l.board[xx][yy]) {
                    g2.drawImage(floorimg.i, xx * 8 + moffx, yy * 8 + moffy, this);
                }
            }
        }
